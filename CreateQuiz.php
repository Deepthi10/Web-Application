  ...
  var nameFlag=false;
	  $(document).ready(function() {
		  ...
		  $("#genQuiz").click(function(e){
			  ...
			  $.ajax({
		          type: "GET",
		          url: "/quizapp_web_dev/services/QuizQuestionGenerator.php?pts="+$("#qpts").val(),
		          data: formData,
		          dataType: "json",
...
// 		  });
	  ...
	  {
		  $.ajax({
	          url: "/quizapp_web_dev/services/GetOptions.php?qid="+x,
	          data:"",
	          type:"GET",
	          dataType: "text",
	          success: function( data, textStatus, jqXHR) {
...
<form id="quizForm" action="/quizapp_web_dev/services/SaveQuiz.php" method="post">
