  ...
  function changeRole()
  {
	  ...
	  if(roleid==0)
	  {
		  ...
		  alert("Username or password is incorrect!!  Please login again");
           document.location.href ="http://qav2.cs.odu.edu/quizapp_web_dev/HomePage.php";
		}
		  else if(roleid==1)
				  {
			  $("#adminMenu").hide();
      ...
      <li  class="dropdown">
         <a class="dropdown-toggle" data-toggle="dropdown" href="#">Questions<span class="caret"></span></a>
		      <ul class="dropdown-menu">
		            <li><a href="javascript:showPage('/quizapp_web_dev/csvQuestions.php')">Upload</a></li>
		            <li><a href="javascript:showPage('/quizapp_web_dev/ta/CreateQuestion.php')">Create</a></li>
		             <li><a href="javascript:showPage('/quizapp_web_dev/ta/ModifyQuestion.php')">Modify</a></li>
		          </ul>
		</li>
        <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Quiz<span class="caret"></span></a>
        	<ul class="dropdown-menu">
        	<li><a href="javascript:showPage('/quizapp_web_dev/CreateCRN.php')">Create CRN</a></li>
        	<li><a href="javascript:showPage('/quizapp_web_dev/QuizList.php')">List</a></li>
            <li><a href="javascript:showPage('/quizapp_web_dev/CreateQuiz.php')">Auto</a></li>
            <li><a href="javascript:showPage('/quizapp_web_dev/CreateComplexQuiz.php')">Manual</a></li>
            <li><a href="javascript:showPage('/quizapp_web_dev/UploadQuiz.php')">Upload</a></li>
            <li><a href="javascript:showPage('/quizapp_web_dev/AssignQuizToCRN.php')">Assign to CRN</a></li>
            <li><a href="javascript:showPage('/quizapp_web_dev/DeleteQuiz.php')">Delete</a></li>
			<li><a href="javascript:showPage('/quizapp_web_dev/ModifyQuiz.php')">Modify</a></li>
          </ul>
          </li>
        <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Tags<span class="caret"></span></a>
        	<ul class="dropdown-menu">
		            <li><a href="javascript:showPage('/quizapp_web_dev/AddTag.php')">Add</a></li>
		    </ul>
        </li>
        <li><a href="javascript:showPage('/quizapp_web_dev/AddStudents.php')">Add Students</a></li>
        <li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">Reports<span class="caret"></span> </a>
					<ul class="dropdown-menu">
						<li><a href="javascript:showPage('/quizapp_web_dev/ReportsHome.php')">Reports on Quiz</a></li>
						<li><a href="javascript:showPage('/quizapp_web_dev/services/AllQuestionAnalysis.php')">Question Analysis</a></li>
					</ul>
				</li>
       ...
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
		            <li><a href="/quizapp_web_dev/HomePage.php">Logout</a></li>
		    </ul>
        </li>
      </ul>
    </div>
     ...
     <div id="adminTAMenu">
      ...
      <li  class="dropdown">
        ...
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">TA<span class="caret"></span></a>
        	<ul class="dropdown-menu">
		            <li><a href="javascript:showPage('/quizapp_web_dev/ta/GetTAList.php')">List</a></li>
		              <li><a href="javascript:showPage('/quizapp_web_dev/ta/AddTA.php')">Add</a></li>
		    </ul>
        </li>
      ...
      <ul class="nav navbar-nav">
        ...
        <li  class="dropdown">
         <a class="dropdown-toggle" data-toggle="dropdown" href="#">CRN<span class="caret"></span></a>
		      <ul class="dropdown-menu">
		    		  <li><a href="javascript:showPage('/quizapp_web_dev/professor/CRNList.php')">List</a></li>
		            <li><a href="javascript:showPage('/quizapp_web_dev/AddCRN.php')">Add</a></li>
		          </ul>
		</li>
        <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">TA<span class="caret"></span></a>
