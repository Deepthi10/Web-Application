...
<script type="text/javascript">
	$(document).ready(function()
		...
		function generateChart()
		{
			...
			$.ajax({
	          type: "GET",
	          url: "/kumar/services/GetQuizData.php?qid="+quizid,
	          data: "",
	          dataType: "text",
		...
		$.ajax({
	          type: "GET",
	          url: "/kumar/services/ResultAnalysis.php?qid="+quizid,
	          data: "",
	          dataType: "text",
	          success: function( data, textStatus, jqXHR) {
	        	//alert(data);
...
function getopts()
	{
		...
		$.ajax({
	          type: "GET",
	          url: "/kumar/services/GetReportOptions.php?yr="+yr+"&sem="+sem,
	          data: "",
	          dataType: "json",
	          success: function( data, textStatus, jqXHR) {
	...
	function getquizopts()
	{
		...
		$.ajax({
	          type: "GET",
	          url: "/kumar/services/GetQuizOptions.php?crn="+crn+"&sec="+sec,
	          data: "",
	          dataType: "text",
	          success: function( data, textStatus, jqXHR) {
		         console.log(data);
	...
	function createLineChart(userid)
	{
		...
		$.ajax({
	          type: "GET",
	          url: "/kumar/services/GetStudentDetails.php?uid="+userid,
	          data: "",
	          dataType: "text",
	          success: function( data, textStatus, jqXHR) {
